...
export const schema = gql`
  type Mutation {
    ...
    updatePosition(position: LocationInput!, heading: Float!,isCrawling: Boolean!,isShooting: Boolean!, isFlying: Boolean!, enteringBuildingPosition: LocationInput , skipValidation: Boolean): Player
    ready: Game
