...
export const updatePosition = (rootValue, {position, heading, isCrawling, isShooting, isFlying, enteringBuildingPosition, skipValidation}: UpdatePositionMutationArgs, {games, game, player}: IGraphQLContext) => {
  if (!game || !player) {
    return null;
  }
