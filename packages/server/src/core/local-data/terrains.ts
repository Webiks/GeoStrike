...
const TERRAIN_BLUE_SWISS_PLAYERS_LOCATION = [
    {
        x: 4327254.413025279,
        y: 621509.1085193334,
        z: 4628696.864167333
...
const TERRAIN_RED_SWISS_PLAYERS_LOCATION = [
    {
        x: 4326255.533279069,
        y: 622128.9874207474,
        z: 4629541.539601765
...
const TERRAIN_BLUE_AUSTRALIA_PLAYERS_LOCATION = [
    {
        x: -3787298.0827794825,
        y: 4351128.063305529,
        z: -2713957.9001589464
    }
];
...
export const TerrainLocation = {
    ...
    SWISS_BLUE: TERRAIN_BLUE_SWISS_PLAYERS_LOCATION,
    SWISS_RED: TERRAIN_RED_SWISS_PLAYERS_LOCATION
};
